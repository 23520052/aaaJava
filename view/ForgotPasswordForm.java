...
class GradientPanel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        // Gradient từ màu cam sang vàng
        Color color1 = new Color(255, 140, 0);   // Màu cam (orange)
        Color color2 = new Color(255, 215, 0);   // Màu vàng ánh kim (gold)
...
public class ForgotPasswordForm extends JFrame{
    ...
    public ForgotPasswordForm() {
        ...
        // Description text
        JLabel descLabel = new JLabel("<html>Nhập email của bạn để nhận mật khẩu tạm thời</html>");
